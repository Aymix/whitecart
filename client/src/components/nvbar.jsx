        ...
        {!user ? (
          <div className="flex gap-3">
            ...
            <button
              ...
              className="cursor-pointer px-6 py-2 border border-primary text-primary hover:bg-primary hover:text-white transition rounded-full"
            >
              Seller
            </button>
          </div>
          ...
          <div className="relative group">
            ...
            <ul className="hidden group-hover:block  absolute top-10 right-0 bg-white shadow border border-gray-200 py-2.5 w-40 rounded-md text-sm z-40">
              <li className="p-1.5 pl-3 font-medium text-primary border-b border-gray-100">
