  ...
  return (
    <div className="relative">
     ...
     <div className='flex items-center mt-6 font-medium gap-4'>
      ...
      <Link to={"/Products"} className='group hidden md:flex items-center gap-2 px-7 md:px-9 py-3 bg-primary hover:bg-primary-dull transition rounded text-white cursor-pointer '>
      Explore deals 
