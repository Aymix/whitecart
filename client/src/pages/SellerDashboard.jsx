...
const SellerDashboard = () => {
  ...
  const handleEdit = (product) => {
    ...
    // Wait for the state to update and then scroll to the form
    setTimeout(() => {
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="p-6">
            ...
            {editingProduct && (
              <div ref={editFormRef} className="mb-8 p-6 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <div 
                      ...
                      className="relative border-2 border-dashed border-gray-300 rounded-lg p-4 h-40 flex flex-col items-center justify-center cursor-pointer hover:border-green-500 transition"
                    >
                      {editingProduct.imagePreview || editingProduct.image ? (
                        <img 
                          src={editingProduct.imagePreview || `http://localhost:5000${editingProduct.image}`} 
                          alt="Product" 
